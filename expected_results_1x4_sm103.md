...
## 6. Side by side — 1x8 B200 (sm_100, EP8) vs 1x4 GB300 (sm_103, EP4)

Convenience view pairing this file's numbers with
[expected_results.md](expected_results.md). **This is not a GPU-vs-GPU
...
### 6b. Kernel microbenchmark

p50 µs per rank; `dg` absolute, the two key CuteDSL variants as each
machine's ratio-vs-its-own-dg (from expected_results.md §3 and §2 above; the
...
### 6c. GSM8K — DeepSeek-V4-Flash, 200 questions
