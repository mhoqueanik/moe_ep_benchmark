...
#
# Derived from job_vllm_pr_runbook_sweep_ep8.sh by swapping the checkpoints to
# V4-Pro and the knob
...
for v in MODEL_MX_PRO MODEL_NVFP4_PRO; do
    [[ -n "${!v:-}" ]] || { echo "$v is unset -- export MODEL_MX_PRO and MODEL_NVFP4_PRO first, see RUNBOOK_REPRO.md 1.3"; exit 2; }
