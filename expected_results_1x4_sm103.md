...
## 6. Side by side with 1x8 B200

The cell-for-cell sm_100 vs sm_103 comparison — e2e, all six kernel shapes
and GSM8K, with the world-size caveat — lives in
[expected_results.md](expected_results.md) §7, next to the B200 numbers it
pairs against.
